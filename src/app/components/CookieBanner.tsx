...
export default function CookieBanner() {
  ...
  return (
    <>
      {/* Load Analytics and Tag Manager only if consent is given */}
      {consent === true && (
        <>
          {/* Google Analytics 4 */}
          <Script src="https://www.googletagmanager.com/gtag/js?id=G-XC6ZB8SJK0" strategy="afterInteractive" />
          <Script id="google-analytics" strategy="afterInteractive">
            {`
              window.dataLayer = window.dataLayer || [];
              function gtag(){dataLayer.push(arguments);}
              gtag('js', new Date());
              gtag('config', 'G-XC6ZB8SJK0');
            `}
          </Script>
